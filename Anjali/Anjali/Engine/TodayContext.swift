...
struct TodayEngineInput {
    ...
    /// IDs of prayers already completed today (deprioritised, not excluded).
    var completedPrayerIDsToday: Set<String>
    ...
    init(
        ...
        completedPrayerIDsToday: Set<String> = []
    ) {
        ...
        self.completedPrayerIDsToday = completedPrayerIDsToday
    }
}
